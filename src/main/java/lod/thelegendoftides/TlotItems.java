...
public final class TlotItems {
  ...
  // Fish
  public static final RegistryDelegate<CarpItem> CARP = ITEM_REGISTRAR.register("carp", () -> new CarpItem(20));
  public static final RegistryDelegate<SilverCarpItem> SILVER_CARP = ITEM_REGISTRAR.register("silver_carp", () -> new SilverCarpItem(40));
  public static final RegistryDelegate<GrandCarpItem> GRAND_CARP = ITEM_REGISTRAR.register("grand_carp", () -> new GrandCarpItem(60));
  public static final RegistryDelegate<MirageCarpItem> MIRAGE_CARP = ITEM_REGISTRAR.register("mirage_carp", () -> new MirageCarpItem(80));
  public static final RegistryDelegate<BlackBassItem> BLACK_BASS = ITEM_REGISTRAR.register("black_bass", () -> new BlackBassItem(30));
  public static final RegistryDelegate<GrandBassItem> GRAND_BASS = ITEM_REGISTRAR.register("grand_bass", () -> new GrandBassItem(60));
  public static final RegistryDelegate<WiseSalmonItem> WISE_SALMON = ITEM_REGISTRAR.register("wise_salmon", () -> new WiseSalmonItem(100));
  ...
  public static final RegistryDelegate<GrandRainbowTroutItem> GRAND_RAINBOW_TROUT = ITEM_REGISTRAR.register("grand_rainbow_trout", () -> new GrandRainbowTroutItem(60));
  public static final RegistryDelegate<MirageTroutItem> MIRAGE_TROUT = ITEM_REGISTRAR.register("mirage_trout", () -> new MirageTroutItem(90));
  public static final RegistryDelegate<RockheadPufferfishItem> ROCKHEAD_PUFFERFISH = ITEM_REGISTRAR.register("rockhead_pufferfish", () -> new RockheadPufferfishItem(40));
  public static final RegistryDelegate<ArgentfinItem> ARGENTFIN = ITEM_REGISTRAR.register("argentfin", () -> new ArgentfinItem(40));
  public static final RegistryDelegate<KoiItem> KOI = ITEM_REGISTRAR.register("koi", () -> new KoiItem(40));
  public static final RegistryDelegate<PricklebackItem> PRICKLEBACK = ITEM_REGISTRAR.register("prickleback", () -> new PricklebackItem(40));
  public static final RegistryDelegate<SwordfishItem> SWORDFISH = ITEM_REGISTRAR.register("swordfish", () -> new SwordfishItem(40));
  public static final RegistryDelegate<SturgeonItem> STURGEON = ITEM_REGISTRAR.register("sturgeon", () -> new SturgeonItem(40));
  public static final RegistryDelegate<ShadeseekerItem> SHADESEEKER = ITEM_REGISTRAR.register("shadeseeker", () -> new ShadeseekerItem(40));
  public static final RegistryDelegate<MurkrayItem> MURKRAY = ITEM_REGISTRAR.register("murkray", () -> new MurkrayItem(40));
  public static final RegistryDelegate<SilverfishItem> SILVERFISH = ITEM_REGISTRAR.register("silverfish", () -> new SilverfishItem(100));
  public static final RegistryDelegate<GoldenfishItem> GOLDENFISH = ITEM_REGISTRAR.register("goldenfish", () -> new GoldenfishItem(250));
  ...
  public static final RegistryDelegate<AzeelTrackerItem> AZEEL_TRACKER = ITEM_REGISTRAR.register("azeel_tracker", () -> new AzeelTrackerItem(1));
