...
public class TlotEquipments {
  ...
  public static final RegistryDelegate<Equipment> BOUNDLESS_PLATE = EQUIPMENT_REGISTRAR.register("boundless_plate", () -> new Equipment(400, 0x0, EquipmentSlot.ARMOUR, LodMod.NO_ELEMENT.get(), new ElementSet(), new ElementSet(), 0x0, 0, 0, 0, 0, 0, -20, 200, 0, false, false, false, false, 0, 0, 0, 0, 0, ItemIcon.ARMOR, 0, 0, 0, 20, 20, 0, 0, 0, 0, 0, 0x0));
  public static final RegistryDelegate<Equipment> BERSERK_PLUME = EQUIPMENT_REGISTRAR.register("berserk_plume", () -> new Equipment(400, 0x0, EquipmentSlot.HELMET, LodMod.NO_ELEMENT.get(), new ElementSet(), new ElementSet(), 0xff, 44, 0, 0, 0, 0, 0, 0, 0, false, false, false, false, 0, 0, 0, 0, 0, ItemIcon.HELM, 20, 0, 0, -10, -10, 0, 0, 0, 0, 0, 0x0));
