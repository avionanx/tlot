...
public class TlotEquipments {
  ...
  public static final RegistryDelegate<Equipment> STORMCROWN = EQUIPMENT_REGISTRAR.register("stormcrown", () -> new Equipment(400, 0x0, EquipmentSlot.HELMET, LodMod.NO_ELEMENT.get(), new ElementSet(), new ElementSet(), 0x0, 10, 0, 0, 0, 0, 10, 10, 0, false, false, false, false, 10, 10, 10, 10, 0, ItemIcon.HELM, 10, 0, 10, 10, 10, 0, 0, 10, 10, 0, 0x0));
