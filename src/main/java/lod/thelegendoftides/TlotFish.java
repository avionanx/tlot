...
public final class TlotFish {
  ...
  public static final RegistryDelegate<Fish> CARP = REGISTRAR.register("carp", () -> new Fish(new FishIcon(0), 1.0f));
  public static final RegistryDelegate<Fish> RAINBOW_TROUT = REGISTRAR.register("rainbow_trout", () -> new Fish(new FishIcon(1), 1.5f));
